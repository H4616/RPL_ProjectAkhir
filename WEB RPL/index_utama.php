...
<nav class="navbar navbar-expand-lg p-3 mb-2 bg-success text-white">
  <div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarScroll">
			...
			<form class="d-flex" method="GET" action="index_utama.php">
				<input class="form-control me-2" type="text" placeholder="Search" aria-label="Search" name="cari" value="<?php if(isset($_GET['cari'])){echo $_GET['cari'];}?>">
	...
	<div class = "container">
		<main class = "grid">
			<article>
			  <a href="makanan.php?email=<?=$data['email']; ?>">
			...
			<article>
			  <a href="pakaian.php?email=<?=$data['email']; ?>">
			...
			<article>
			  <a href="kerajinan.php?email=<?=$data['email']; ?>">
			...
			<article>
			  <a href="elektronik.php?email=<?=$data['email']; ?>">
			...
			<article>
			  <a href="kendaraan.php?email=<?=$data['email']; ?>">
			...
			<article>
			  <a href="parabotan.php?email=<?=$data['email']; ?>">
...
<center>
			<h1>Pilih Belanjamu</h1>
</center>
		<br><br><br>
						<?php
						
							include('koneksi.php');
							$query = mysqli_query($connect,"SELECT * FROM `index`");
					...
					<div class="container text-center">
						<div class="row">
							...
							<div class="col">
								<br><br><br>
								<a href="kasir.php?id_barang=<?=$item['id_barang']; ?>"><button  class="btn btn-primary" style="margin-right: 5cm;"> Beli Sekarang</button></a>
