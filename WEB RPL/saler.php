...
<html lang="en">
  <head>
    ...
    <title>Toko Warung Online</title>
...
<nav class="navbar navbar-expand-lg p-3 mb-2 bg-success text-white">
  <div class="container-fluid">
        ...
        <center>
           <h1>Selamat Datang Di Toko! <?=$data['username']; ?></h1> 
        </center>
        <br><br><br><br>
        ...
        <div class="container text-center">
            <div class="row">
				...
				<?php
					include('koneksi.php');
					$email = $_GET['email'];
					$sql	= "SELECT * FROM nota WHERE email_saler='$email'";
                ...
                <center>
                <form enctype="multipart/form-data" method="POST" action="saler_proses.php">
				<table class="table" style=" background-color: #EBF1FF; border-radius: 5%;">
      
					<tr style="color: #0BABC3;" valign="middle" align="center">
						<td>Nama</td>
					...
					<tr style="color: #0BABC3;" valign="middle" align="center">
						<td>Kategori</td>
						<td>
                            <p><input type="radio" name="kategori" value="Makanan">Makanan</p>
                            <p><input type="radio" name="kategori" value="Pakaian">Pakaian  </p>
                            <p><input type="radio" name="kategori" value="Kerajinan">Kerajinan</p>
                        </td>
                        <td>
                            <p><input type="radio" name="kategori" value="Elektronik">Elektronik</p>
                            <p><input type="radio" name="kategori" value="Kendaraan">Kendaraan</p>
                            <p><input type="radio" name="kategori" value="Parabotan">Parabotan</p>
                        </td>
					</tr>
					<tr style="color: #0BABC3;" valign="middle" align="center" hidden>
						<td>no hp</td>
					...
					<tr style="color: #0BABC3;" valign="middle" align="center" hidden>
						<td>nama toko</td>
						<td><input type="text" name="toko" value="<?=$data['nama_toko']; ?>"></td>
					</tr>
                    <tr style="color: #0BABC3;" valign="middle" align="center" >
						<td>Foto</td>
                ...
                //cari id terbesar
                $query = mysqli_query($connect, "SELECT MAX(id_barang) as tbsr FROM `index` ");
                $data = mysqli_fetch_array($query);
                $barang = $data['tbsr'];              
                $barang++;
                ...
                ?>
                     ...
                     <tr style="color: #0BABC3;" valign="middle" align="center" hidden >
						<td>id</td>
						<td><input type="int" name="id" value="<?php echo $barang ?>"></td>
					</tr>
